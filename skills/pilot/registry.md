...
| 1. Frame (non-code) | "idea"; "what if"; "explore"; "thinking about"; "is this worth building" | `grill-me` | `office-hours` (product interrogation — is the problem real, who has it, vendored from gstack), `gsd-explore` | non-code keywords; use `office-hours` when the question is product viability rather than design |
